...
public class TestDialogue : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        theSourceFile = new FileInfo("Assets/TextFiles/Dialogue3.txt"); //Change File name
        reader = theSourceFile.OpenText();

        PeopleSourceFile = new FileInfo("Assets/TextFiles/Dialogue3People.txt"); //Change File name
